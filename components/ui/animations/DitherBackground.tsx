...
// Extend the fiber catalog with required Three.js objects
extend({ 
  Mesh: THREE.Mesh,
...
const WrappedRetro = wrapEffect(RetroEffectImpl) as React.ForwardRefExoticComponent<
  React.PropsWithoutRef<{ colorNum: number; pixelSize: number }> & React.RefAttributes<unknown>
>;
...
export default function DitherBackground({
  ...
  waveFrequency = 1,
  waveAmplitude = 0,
  waveColor = [0.3, 0.3, 0.3] as [number, number, number], // Dark grey color
  colorNum = 1,
  pixelSize = 1,
  ...
  return (
    <div 
      ...
      style={{ 
        zIndex: 1, // Higher z-index but still behind content
